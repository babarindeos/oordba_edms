...
<body>
    <div class="border-0 flex flex-row justify-center items-center font-bold text-blue-900 header-title">
        OGUN-OSHUN RIVER BASIN DEVELOPMENT AUTHORITY
    </div>
    <div class="border-0 flex flex-row justify-center items-center text-2xl font-semibold managing-director">
        ...
        <div class="flex w-[80%] border-0">           
            ...
            <div class="flex flex-1 flex-col">
                <div class="flex flex-row w-full py-1">
                    <div class="flex ref-label">
                        Our Ref:
                    </div>
                    <div class="flex-1 border-b px-1 border-b-black"></div>
                </div>
                <div class="border-1 flex flex-row w-full py-1">
                    <div class="flex ref-label">
                        Your Ref:
                    </div>
                    <div class="flex-1 border-b px-1 border-b-black">
                        hhhhhh
                    </div>
                </div>
                <div>Website: www.oorbda.org</div>
                <div>E-mail: info@oorbda.org</div>
            </div>
            <!-- end of left pane -->
            ...
            <div class="border-0 flex flex-col flex-1 justify-end">
                <div class="headquarters-text">Headquarters:</div>
                <div class="headquarters-text">Alabata Road, P.M.B 2115</div>
                <div class="headquarters-text">Abeokuta, Ogun State.</div>
                <div class="headquarters-text items-center"><i class="fa-solid fa-tty px-1"></i>:039-779422</div>
            </div>
            <!-- end of right pane -->
        </div>
    </div>
