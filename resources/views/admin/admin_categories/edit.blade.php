...
<div class="container mx-auto">
        ...
        <section>
                <div>
                    <form  action="{{ route('admin.admin_categories.update',['admin_category'=>$admin_category->id]) }}" method="POST" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        @csrf
                        ...
                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] py-2">
                            ...
                            <select name="category_type" class="border border-1 border-gray-400 bg-gray-50
                                                                    ...
                                                                    @foreach($admin_category_types as $cat_types)
                                                                        <option @if($admin_category->admin_category_type_id == $cat_types->id) selected  @endif value="{{ $cat_types->id }}">{{ $cat_types->name }}</option>
                                                                    @endforeach
