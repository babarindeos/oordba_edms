                ...
                <div>
                    <form  action="{{ route('admin.colleges.store')}} " method="POST" class="flex flex-col mx-auto w-[90%] items-center justify-center">
                        ...
                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] py-3">
                            ...
                            <input type="text" name="college_name" class="border border-1 border-gray-400 bg-gray-50
                        ...
                        <div class="flex flex-col border-red-900 w-[80%] md:w-[60%] py-3">
                            ...
                            <input type="text" name="college_code" class="border border-1 border-gray-400 bg-gray-50
                                                                    w-full p-4 rounded-md 
                                                                    focus:outline-none
                                                                    focus:border-blue-500 
                                                                    focus:ring
