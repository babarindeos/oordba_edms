                    ...
                    @foreach($branches as $branch)
                        <tr class="border border-b border-gray-200 ">
                            ...
                            <td>
                                        ...
                                        <div class="text-sm">
                                            {{ $branch->division->department->department_name }} ({{ $branch->division->department->department_code }})
                                        </div>
                            </td>
                            <td>
                            ...
                            <td class="text-center">
                                ...
                                <span> 
                                    <a class="hover:bg-red-500 bg-red-400 text-white rounded-md 
                                              px-4 py-1 text-xs" href="{{ route('admin.branches.destroy', ['branch'=>$branch->id])}}"
                                    >Delete</a>
                                </span>
                            </td>
                        </tr>
