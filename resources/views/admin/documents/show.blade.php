<x-admin-layout>
    <div class="flex flex-col container mx-4 mb-8 border-0 md:mx-auto">
                                            ...
                                            @foreach ($general_messages as $message)
                                                <div class="flex flex-row my-2">
                                                        ...
                                                        <div class="px-3 py-1 rounded-md bg-gray-100 w-full">
                                                                <a href="{{ route('admin.profile.user_profile', ['fileno'=>$message->sender->staff->fileno]) }}"  class="font-semibold text-sm hover:underline">
